...
public class PortfolioRequest : JSONGenerator {
    ...
    PortfolioRequest(int[] childPorts) : this() {
        int n;
    ...
    public PortfolioRequest(int portNum,int[] childPorts) :this(childPorts) {
        parentPortfolioId = portNum.ToString();
    }

    public PortfolioRequest(string p1,int[] p2) :this(p2){
        this.userid = p1;
    }
