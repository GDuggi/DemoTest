...
public interface Confirmation {
	...
	DocVaultResponse storeContract(DocVaultRequest request,String userName);
	...
	ContractResponse getContractFromVault(ContractRequest request,String userName);
	ContractResponse storeContractInVault(ContractRequest request,String userName);
