...
public class TradeRqmtConfirm implements Serializable{
	...
	private String _preparerCanSendFlag = null;
...
//	@SpaceProperty(nullValue="-1")
 ...
 //   @SpaceProperty(nullValue="-1")
	...
	public String get_preparerCanSendFlag(){
		return _preparerCanSendFlag;
	}
	public void set_preparerCanSendFlag(String preparerCanSendFlag) {
		_preparerCanSendFlag = preparerCanSendFlag;
	}

	@Override
	public String toString(){
    	return _id+"|"+_rqmtId+"|"+_tradeId+"|"+_templateId+"|"+_confirmLabel+"|"+_confirmCmt+"|"+_faxTelexInd+"|"+_faxTelexNumber+"|"+_xmitStatusInd+"|"+_xmitAddr+"|"+_xmitCmt+"|"+_xmitTimeStampGmt+"|"+_templateName+"|"+_templateCategory+"|"+_templateTypeInd+"|"+_finalApprovalFlag+"|"+_preparerCanSendFlag;
