...
//	@SpaceClass
	public class RqmtData implements Serializable {
		...
		private String _trdSysTicket = null;
		private String _trdSysCode = null;
	...
	//    @SpaceProperty(index = SpaceProperty.IndexType.BASIC,nullValue="-1")
		...
		public String get_trdSysTicket() {
			return _trdSysTicket;
		}

		public void set_trdSysTicket(String _trdSysTicket) {
			this._trdSysTicket = _trdSysTicket;
		}
	...
	//    @SpaceProperty(index = SpaceProperty.IndexType.BASIC, nullValue="-1")
		...
		public String toString(){
	    	return _id+"|"+_tradeId+"|"+_rqmtTradeNotifyId+"|"+_rqmt+"|"+_trdSysTicket+"|"+_trdSysCode+"|"+_status+"|"+_completedTimestampGmt+"|"+_completedDt+"|"+_reference+"|"+_cancelTradeNotifyId+"|"+_cmt+"|"+_secondCheckFlag+"|"+_transactionSeq+"|"+_finalApprovalFlag+"|"+_displayText+"|"+_category+"|"+_terminalFlag+"|"+_problemFlag+"|"+_guiColorCode+"|"+_delphiConstant+"|"+_prelimAppr;
	    }
