...
REM
echo Upgrading CNF_MGR database (MS SQL Server) for issue #ADCM-99 ...
REM ********************************************************************************
echo ********************************************************************************
REM ********************************************************************************
echo Upgrating USER_ROLE Table(s) ...
%ISQL% -S %1 -U %2 -P %3 -d %4 -w 600 -i UUU_USER_ROLE\ALTERS_USER_ROLE.sql -o logs\ALTERS_USER_ROLE.log
echo Done
echo ********************************************************************************
echo NOTE:
