...
REM
echo Upgrading CNF_MGR database (MS SQL Server) for issue #ADCM-134 ...
REM ********************************************************************************
echo ********************************************************************************
REM ********************************************************************************
echo Status Change(s) ...
cd UUU_rqmt_status
%ISQL% -S %1 -U %2 -P %3 -d %4 -w 600 -i StatusChanges.sql -o logs\StatusChanges.log
cd..
echo Done
echo ********************************************************************************
echo NOTE:
