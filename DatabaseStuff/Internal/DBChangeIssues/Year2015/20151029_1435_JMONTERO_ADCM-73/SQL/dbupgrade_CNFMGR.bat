...
REM
echo Upgrading CNF_MGR database (MS SQL Server) for issue #ADCM-73 ...
REM ********************************************************************************
echo ********************************************************************************
REM ********************************************************************************
echo Upgrading Trigger(s) ...
cd AAA_TRADE_APPR
%ISQL% -S %1 -U %2 -P %3 -d %4 -w 600 -i TG_TRADE_APPR_AER_I.sql -o logs\TG_TRADE_APPR_AER_I.log
cd..
echo Done
echo ********************************************************************************
echo NOTE:
