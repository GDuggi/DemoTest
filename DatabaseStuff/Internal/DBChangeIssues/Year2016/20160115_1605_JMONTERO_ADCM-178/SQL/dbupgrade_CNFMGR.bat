...
:start
REM
echo Upgrading CONFIRMATION MANAGER database (MS SQL Server) for issue #ADCM-178 ...
REM ********************************************************************************
echo ********************************************************************************
echo Altering TG_TRDDATA_AER_U Procedure(s)
%ISQL% -S %1 -U %2 -P %3 -d %4 -w 250 -i UUU_TG_TRDDATA_AER_U\TG_TRDDATA_AER_U.sql -o logs\TG_TRDDATA_AER_U.log
REM ********************************************************************************
echo ******************************************************************************** 
