...
:start
REM
echo Upgrading CONFIRMATION MANAGER database (MS SQL Server) for issue #ADCM-176 ...
REM ********************************************************************************
echo ********************************************************************************
echo Altering TG_TRDSUMMRY_AU Procedure(s)
%ISQL% -S %1 -U %2 -P %3 -d %4 -w 250 -i UUU_TRADE_SUMMARY\TG_TRDSUMMRY_AU.SQL -o logs\TG_TRDSUMMRY_AU.log
REM ********************************************************************************
echo ******************************************************************************** 
